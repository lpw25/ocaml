...
val check: t -> Unit_name.t -> Digest.t -> string -> unit
...
val check_noadd: t -> Unit_name.t -> Digest.t -> string -> unit
      (* Same as [check], but raise [Not_available] if no CRC was previously
           associated with [name]. *)

val set: t -> Unit_name.t -> Digest.t -> string -> unit
