...
and expression_desc =
  ...
  | Texp_function of { param_label : param_label; param : Ident.t;
...
and class_expr_desc =
  ...
  | Tcl_fun of
      param_label * pattern * (Ident.t * expression) list
      * class_expr * partial
...
and core_type_desc =
    Ttyp_any
  | Ttyp_var of string
  | Ttyp_arrow of param_label * core_type * core_type
...
and class_type_desc =
  ...
  | Tcty_arrow of param_label * core_type * class_type
