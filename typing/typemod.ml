...
let iterator_with_env env =
  ...
  env, { super with
    ...
    | Mty_functor (param, mty_arg, mty_body) ->
      ...
      let env_before = !env in
      env := lazy (Env.add_module ~arg:true param Mta_present
...
and type_module_aux ~alias sttn funct_body anchor env smod =
  ...
  | Pmod_ident lid ->
      ...
      | Mty_alias(p1, _) as mty when not alias ->
        ...
        Mty_functor(param, mty_param, mty_res) as mty_functor ->
          ...
          let mty_appl =
            ...
            | None ->
                ...
                let env =
                  Env.add_module ~arg:true param Mta_present arg.mod_type env
                in
...
let rec package_signatures subst = function
  ...
  | (name, sg) :: rem ->
      ...
      Sig_module(newid, Mta_present, {md_type=Mty_signature sg';
                 ...
                 Trec_not) ::
      package_signatures (Subst.add_module oldid (Pident newid) subst) rem (* TODO This substitution has Tcoerce_none coercion *)
